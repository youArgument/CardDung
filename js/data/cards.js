...
const FALLBACK_CARDS = [
  ...
  // === Server-only cards (added via API) ===
  { id: 'whirlwind', nameEn: 'Whirlwind', nameRu: 'Вихрь', descEn: 'STR AOE physical strike', descRu: 'Физический удар по всем от Силы', cost: 3, sprite: '🌀', type: 'attack-all', rarity: 'legendary', baseDamage: 5, mainStat: 'STR', requiredStat: 10, scaling: 0.45, damageType: 'Physical', tags: ['Melee', 'AOE'], effects: [{ action: 'damage_all' }] },
  { id: 'iron_skin', nameEn: 'Iron Skin', nameRu: 'Железная Кожа', descEn: 'Gain heavy armor based on VIT+STR', descRu: 'Тяжёлая броня от Выносливости+Силы', cost: 2, sprite: '🛡️', type: 'armor', rarity: 'rare', baseDamage: 5, statWeights: { VIT: 0.7, STR: 0.3 }, requiredStat: 8, scaling: 0.40, damageType: 'Armor', tags: ['Defense'], effects: [{ action: 'armor' }] },
  { id: 'assassinate', nameEn: 'Assassinate', nameRu: 'Убийство', descEn: 'Massive AGI execution strike', descRu: 'Мощный удар Ловкостью-исполнением', cost: 3, sprite: '💀', type: 'attack', rarity: 'legendary', baseDamage: 12, mainStat: 'AGI', requiredStat: 10, scaling: 0.55, damageType: 'Physical', tags: ['Melee', 'Backstab'], effects: [{ action: 'damage' }] },
  { id: 'swift_strikes', nameEn: 'Swift Strikes', nameRu: 'Быстрые Удары', descEn: 'Rapid AGI assault with STR power', descRu: 'Быстрая атака Ловкостью+Силой', cost: 2, sprite: '⚡', type: 'attack', rarity: 'rare', baseDamage: 6, statWeights: { AGI: 0.7, STR: 0.3 }, requiredStat: 7, scaling: 0.45, damageType: 'Physical', tags: ['Melee'], effects: [{ action: 'damage' }] },
  { id: 'execute', nameEn: 'Execute', nameRu: 'Казнь', descEn: 'AGI+STR finishing blow', descRu: 'Финальный удар Ловкости+Силы', cost: 3, sprite: '⚰️', type: 'attack', rarity: 'legendary', baseDamage: 10, statWeights: { AGI: 0.6, STR: 0.4 }, requiredStat: 9, scaling: 0.50, damageType: 'Physical', tags: ['Melee'], effects: [{ action: 'damage' }] },
];
